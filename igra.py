...
def evaluate(kopija_ploce, zadnji_igrac, dubina):
    svi_porazi = True
    sve_pobjede = True
    #trenutna_ploca = Ploca(brojRedaka=7, zadana_ploca=kopija_ploce)
...
if __name__ == '__main__':
    ...
    if rank == 0:
        ...
        kraj_radnik = False
        kopija_ploce = Ploca(brojRedaka=7)
        # potez1, potez2 = None, None
